...
public class MenuController {
    ...
    private void querySubMenu(TreeNode<Map<String, Object>> parent_menu, Integer user_id) {
        String sql = "select distinct a.menu_code,a.menu_name,a.controller_full_classname,a.default_view_classname,a.icon_url from sys_menu a inner join sys_role_to_menu b on a.menu_code=b.menu_code \n" +
