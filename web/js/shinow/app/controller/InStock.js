 ...
 */
 Ext.define('app.controller.InStock',{
		...
		requires : [ 'app.model.InStock', 'app.store.InStock','app.view.instock.InStock_List','app.view.instock.InStock_Add','app.view.instock.InStock_Edit' ],
		models: ['InStock'],
		...
		refs : [
			{
				...
				selector : 'InStock_List>gridpanel'
			}
		],
		init : function(application) {
			var me = this;
			me.control({
				'InStock_List>gridpanel':{
